...
def data_pengiriman():
    ...
    kurir = input ("Pilih Opsi Kurir: ")
    if kurir == "1":
        print ("Pengiriman Menggunakan JNE, dengan nama", nama_pembeli ,)
        print ("Provinsi: ", provinsi_pembeli)
        print ("Alamat: ", alamat_pembeli)
        print ("Nomor HP: ", no_pembeli)

    elif kurir == "2":
        print ("Pengiriman Menggunakan SiCepat Express, dengan nama", nama_pembeli ,)
        print ("Provinsi: ", provinsi_pembeli)
        print ("Alamat: ", alamat_pembeli)
        print ("Nomor HP: ", no_pembeli)
    
    elif kurir == "3":
        print ("Pengiriman Menggunakan JNT, dengan nama", nama_pembeli ,)
        print ("Provinsi: ", provinsi_pembeli)
        print ("Alamat: ", alamat_pembeli)
        print ("Nomor HP: ", no_pembeli)
    
    elif kurir == "4":
        print ("Pengiriman Menggunakan Trijaya Express, dengan nama", nama_pembeli ,)
        print ("Provinsi: ", provinsi_pembeli)
        print ("Alamat: ", alamat_pembeli)
        print ("Nomor HP: ", no_pembeli)
